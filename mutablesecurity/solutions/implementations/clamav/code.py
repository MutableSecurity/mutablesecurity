...
class FreshClamLogs(BaseLog):
    IDENTIFIER = "freshclam_logs"
    DESCRIPTION = "The logs generated by FreshClam"
    LOCATION = "/var/log/clamav/freshclam.log"
    FORMAT = LogFormat.TEXT


class ClamAVLogs(BaseLog):
    IDENTIFIER = "clamav_logs"
    DESCRIPTION = "The logs generated by ClamAV"
    LOCATION = "/var/log/clamav/clamav.log"
    FORMAT = LogFormat.TEXT


class ScanLogs(BaseLog):
    IDENTIFIER = "scan_logs"
    DESCRIPTION = "The logs generated during ClamAV scanning"
    LOCATION = ScanLogLocation
    FORMAT = LogFormat.TEXT
...
class Clamav(BaseSolution):
    ...
    LOGS = [
        FreshClamLogs,  # type: ignore[list-item, var-annotated]
        ClamAVLogs,  # type: ignore[list-item, var-annotated]
        ScanLogs,  # type: ignore[list-item, var-annotated]
    ]
